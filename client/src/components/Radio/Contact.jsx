...
export default function Contact({ website, email, phone, location, title }) {
      ...
      <address className={styles.ContactContainer}>
        {website ? (
          <li>
            ...
            <a href={website} target="_blank" title={`${title} στο web`}>
              ...
              {phone.map((phone, ix) => (
                <li key={phone}>
                  <a
                    href={`tel:${phone}`}
                    title={`${
                      phone.length > 1 ? `${ix + 1}ος` : ""
                    } τηλεφωνικός αριθμός "${title}" `}
                  >
                    {phone}
                  </a>
                </li>
